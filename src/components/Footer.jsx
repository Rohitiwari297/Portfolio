...
function Footer() {
  return (
    <footer className="sticky bottom-0 w-full bg-gradient-to-t from-[#0b0b0d] via-[#101214] to-[#1a1c1e] text-gray-400 py-10 px-6 md:px-20">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        ...
        {/* Right: Social Links */}
        <div className="flex space-x-6 text-xl justify-center md:justify-end">
          {[ 
